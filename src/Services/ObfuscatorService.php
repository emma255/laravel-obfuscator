...
namespace Honeycrisp\Honeycrisp\Services;
...
class ObfuscatorService
{
    ...
    private function checkLicense(): void
    {
        if (!$this->licenseService->isValid()) {
            throw new \Exception('Invalid or expired license. Please check your Honeycrisp license.');
        }
    }
    ...
    {
        $wrapper = '<?php' . "\n";
        $wrapper .= '// Obfuscated PHP Code - Generated by Honeycrisp' . "\n";
